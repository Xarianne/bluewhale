...
- **`ghcr.io/xarianne/bluewhale:noctalia`** (branch: `noctalia`) — Silverblue (GNOME) with the [Noctalia](https://noctalia.dev/) family instead: Noctalia shell, the Umbriel compositor, and Noctalia Greeter (via greetd) replacing GDM as the login screen. Details: [docs/noctalia.md](docs/noctalia.md)
