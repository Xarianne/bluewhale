...
- **`ghcr.io/xarianne/bluewhale-testing:latest`** — same image on the branched pre-release Fedora (currently F45), with Bodhi karma tooling (`fedora-easy-karma`, `bodhi-client`); `updates-testing` is enabled by default during the pre-release phase. Details: [docs/fedora-testing.md](docs/fedora-testing.md)
